...
module.exports =
  ...
  newUser: () ->
    ...
    defaultTasks = [
      ...
      {type: 'todo', text: 'Call Mom', notes: 'While not completing a to-do in a set period of time won't hurt you, they will gradually change from yellow to red, thus becoming more valuable. This will encourage you to wrap up stale To-Dos.', value: -3, completed: false }
